                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.courses.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="course_code" class="mt-1 block w-full bg-gray-900 border-gray-700 rounded-md shadow-sm text-gray-100" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-300">Course Name</label>
                            <input type="text" name="course_name" class="mt-1 block w-full bg-gray-900 border-gray-700 rounded-md shadow-sm text-gray-100" required>
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="credits" class="mt-1 block w-full bg-gray-900 border-gray-700 rounded-md shadow-sm text-gray-100" required>
                            </div>
                            <div>
